...
The Book carries four **keystone spells** of its own authorship — native magic, not gathered:
...
- **[`the-emissary`](./the-emissary)** — *the spell that finds servers.* The grimoire's cousin for the Many-Channelled Pact: it searches the official MCP Registry on demand (a tiny, portable helper script) and **proposes** an Emissary's connection for you to approve — discovery without ever auto-binding a live tool.
